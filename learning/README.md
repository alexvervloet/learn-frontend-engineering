...
| --------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------- |
| [react-core](react-core/)                     | 🟢       | State, effects, refs, context, reducers, transitions, Suspense, and the 19.2 additions                  |
...
| [styling](styling/)                           | 🟢       | CSS modules, Tailwind 4, `light-dark()` tokens, container queries, cascade layers, cva, motion, popover |
